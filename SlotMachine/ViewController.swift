...
class ViewController: UIViewController {
    ...
    // Button for the fourth container
    ...
    override func viewDidLoad() {
        ...
        hardReset() //Set up the second container as well
    }
    ...
    func setupContainerViews() {
        // Specify the x and y coordinate of the first container view and its width and height
        self.firstContainer = UIView(frame: CGRect(x: self.view.bounds.origin.x + kMarginForView, y: self.view.bounds.origin.y, width: self.view.bounds.width - (kMarginForView * 2), height: self.view.bounds.height * kSixth))
        // Set the background color of your firstcontainer view
        self.firstContainer.backgroundColor = UIColor.redColor()
        // Add a subview to our current view
